...
std::string GioData::getValue(size_t index)
{
    ...
    if (dataType == "float")
        ...
        ss << ((int8_t*) data)[index];
    else if (dataType == "int16_t")
        ss << ((int16_t*) data)[index];
    else if (dataType == "int32_t")
        ss << ((int32_t*) data)[index];
    else if (dataType == "int64_t")
        ss << ((int64_t*) data)[index];
    else if (dataType == "uint8_t")
        ss << ((uint8_t*) data)[index];
    else if (dataType == "uint16_t")
        ss << ((uint16_t*) data)[index];
    else if (dataType == "uint32_t")
        ss << ((uint32_t*) data)[index];
    else if (dataType == "uint64_t")
        ss << ((uint64_t*) data)[index];
